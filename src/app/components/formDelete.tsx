...
import { CloseButton } from './ui/animated-modal'
...
export default function FormDelete({ deleteData, id }: FormDeleteProps) {
  const ActionDelete = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
